# Minna no Nihongo Lesson 02 (第2課)

**Status**: 🟨 Reviewing
**Date Started**: 2026-07-23
**Focus**: Demonstratives (これ/それ/あれ, この/その/あの), Possessions, Identification

---

## 📌 Overview & Objectives (ရည်ရွယ်ချက်)
- ကိုယ့်အနားရှိပစ္စည်း (これ = ဒါ)၊ နားထောင်သူအနားရှိပစ္စည်း (それ = အဲဒါ)၊ နှစ်ယောက်လုံးနှင့်ဝေးသောပစ္စည်း (あれ = ဟိုဒါ) တို့ကို ပြောဆိုနိုင်ရန်။
- ပစ္စည်းပိုင်ရှင်ကို `だれの` (ဘယ်သူ့ဟာလဲ) ဖြင့် မေးမြန်းနိုင်ရန်။
- `これ` (ဒါ) နှင့် `この＋Noun` (ဒီ [Noun]) တို့၏ ကွာခြားချက်ကို နားလည်ရန်။
...
1. **[ Pattern 1: これ / それ / あれ ]**
   - 例: 本 ➔ **これは 本です。** *(ဒါက စာအုပ် ဖြစ်ပါတယ်။)*
...
1. **[ Dialogue Drill: Asking Owners ]**
